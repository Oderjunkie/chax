...
#include "recursion/second.h"
  ...
  #define _chax_autoprintf1(...) _chax_obstruct(_chax_autoprintf7)()(_chax_vaopt((__VA_ARGS__), ,) _chax_autoprintf2(__VA_ARGS__), _chax_autoprintf8(printf("\n")))
  #define _chax_autoprintf2(car, ...) (_chax_autoprintf8(_chax_autoprintf4(car)) || _chax_obstruct(_chax_autoprintf3)()(__VA_ARGS__))
  ...
  #define _chax_autoprintf7() _chax_second
  static int _chax_autoprintf8(int n) { return n >= 0 ? 0 : n; }
#endif