...
#include "ifptr.h"
        ...
        #define _chax_printfspecifier(callback, x, ...) _Generic((x), \
          ...
          unsigned int: _chax_obstruct(callback)()("%u" ___chax_vaopt((__VA_ARGS__), ,) __VA_ARGS__), \
          ...
          long double: _chax_obstruct(callback)()("%Lg" ___chax_vaopt((__VA_ARGS__), ,) __VA_ARGS__), \
